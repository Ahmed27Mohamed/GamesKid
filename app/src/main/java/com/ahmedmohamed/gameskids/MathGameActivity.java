...
public class MathGameActivity extends AppCompatActivity {
    ...
    private void getARandomQuestion() {
        ...
        int optionA = new Random().nextInt(10); // max number 10 , 10 * 10 = 100 then we add 100 as a max number
        int optionB = new Random().nextInt(10);
    ...
    public void reward() {
        ...
        if (great < 5) {
            ...
            TextView result = dialog.findViewById(R.id.got);

            result.setText("حاول مره تانيه جبت = " + great);
            ...
            result.setText("برافو عليك جبت = " + great);
